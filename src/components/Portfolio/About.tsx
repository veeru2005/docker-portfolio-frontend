...
const About: React.FC = () => {
  const technicalSkills = [
    { name: 'React', icon: <img src="/portfolio_front1/react.svg" alt="Docker" style={{ width: 48, height: 48 }} /> },
    { name: 'TypeScript', icon: <img src="/portfolio_front1/typescript.svg" alt="TypeScript" style={{ width: 48, height: 48 }} /> },
    { name: 'JavaScript', icon: <img src="/portfolio_front1/javascript.svg" alt="JavaScript" style={{ width: 48, height: 48 }} /> },
    { name: 'SpringBoot', icon: <img src="/portfolio_front1/springboot.svg" alt="SpringBoot" style={{ width: 48, height: 48 }} /> },
    { name: 'MySQL', icon: <img src="/portfolio_front1/mysql.svg" alt="MongoDB" style={{ width: 48, height: 48 }} /> },
    { name: 'MongoDB', icon: <img src="/portfolio_front1/mongodb.svg" alt="MongoDB" style={{ width: 48, height: 48 }} /> },
    { name: 'AWS/Cloud', icon: <img src="/portfolio_front1/aws.svg" alt="AWS/Cloud" style={{ width: 48, height: 48 }} /> },
    { name: 'Docker', icon: <img src="/portfolio_front1/docker.svg" alt="AWS/Cloud" style={{ width: 48, height: 48 }} /> },
  ...
  const editingSkills = [
    { name: 'Photoshop', icon: <img src="/portfolio_front1/photoshop.svg" alt="Photoshop" style={{ width: 48, height: 48 }} /> },
    { name: 'Premiere Pro', icon: <img src="/portfolio_front1/premiere-pro.svg" alt="Premiere Pro" style={{ width: 48, height: 48 }} /> },
    { name: 'DaVinci Resolve', icon: <img src="/portfolio_front1/davinci.svg" alt="DaVinci Resolve" style={{ width: 48, height: 48 }} /> },
