...
const API_BASE_URL = 'http://16.171.65.245:8083/portfolio_back1';
...
const AdminProjects: React.FC = () => {
  ...
  const [projectForm, setProjectForm] = useState<ProjectForm>({
    ...
    title: '',
    description: '',
    imageUrl: '/portfolio_front1/placeholder.svg',
    imageFile: null,
    technologies: '',
    liveUrl: '',
    githubUrl: ''
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr', lg: '1fr 1fr 1fr' }, gap: 4 }}>
          {projects.map(project => (
            <Card key={project.id} sx={{ display: 'flex', flexDirection: 'column', borderRadius: 2, transition: 'transform 0.3s ease, box-shadow 0.3s ease', '&:hover': { boxShadow: 6 } }}>
              <CardMedia component="img" height="200" image={project.imageUrl} alt={project.title} onError={e => { e.currentTarget.src = '/portfolio_front1/placeholder.svg'; }} />
        ...
        <Dialog open={isProjectDialogOpen} onClose={closeProjectDialog} fullWidth maxWidth="sm">
          ...
          <DialogActions>
            ...
            <Button variant="contained" onClick={saveProjectFromForm} disabled={saving} sx={{ position: 'relative' }}>
